...
def render(cfg: "AppConfig") -> None:
    from app_update.core.loaders import load_graph_cache, build_graph_id_map, load_all_records_list
    from app_update.core.ui import build_pyvis_html
    ...
    available_models = [
        ...
        if (cfg.graph_cache_dir / f"split_cache_{m}.pkl").exists()
    ]
    ...
    with t_arc:
        try:
            from app_update.core.loaders import get_predictor
