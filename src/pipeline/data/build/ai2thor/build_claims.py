...
from src.adapters.ai2thor.nlg.semantics.semantic_rules import get_preferred_receptacles
from src.adapters.ai2thor.knowledge.ids.object_types import ObjectType
...
from src.adapters.ai2thor.nlg.semantics.entity_lexicon import (
    create_ai2thor_object_type_lexicon,
)
from src.adapters.ai2thor.nlg.semantics.predicate_lexicon import create_predicate_lexicon
from src.adapters.ai2thor.nlg.template import Ai2ThorTemplate
from src.nlg.triple_realizer import TripleRealizer
from src.infra.graph.types import TripleList
...
def build_claims(
    ...
    for context in contexts:
        ...
        claim_generator = ClaimGenerator(
            ...
            source="sensor",
            source_type=EvidenceType.PERCEPTION,
