...
from src.core.gnn.heads import ISHead, StanceHead, VerdictHead
from src.core.gnn.types import VERDICT_TO_INT, NodeType
    ...
    def _soft_verdict_logits(
        ...
        if batch_ptr is None:
            batch_ptr = torch.zeros(
                stance_logits.shape[0], dtype=torch.long,
