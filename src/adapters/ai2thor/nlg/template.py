...
from src.ports.template import BaseTemplate
from src.ontology.semantics.predicate_lexicon import PredicateForm, PredicateLexicon
from src.nlg.sentence_template import SentenceTemplate
