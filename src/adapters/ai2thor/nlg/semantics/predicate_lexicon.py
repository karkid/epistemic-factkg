...
from src.ontology.semantics.predicate_lexicon import (
    PredicateForm,
    PredicateLexeme,
    PredicateLexicon,
)
from src.adapters.ai2thor.knowledge.ids.predicates import PredicateId
...
def create_predicate_lexicon() -> PredicateLexicon:
    ...
    # ---------- spatial (PREP) ----------
    lex.register(
        PredicateId.onTopOf.value, PredicateLexeme(kind=PredicateForm.PREP, label="on")
    )
    lex.register(
        PredicateId.inside.value,
        PredicateLexeme(kind=PredicateForm.PREP, label="inside"),
    )
    lex.register(
        PredicateId.near.value, PredicateLexeme(kind=PredicateForm.PREP, label="near")
    )
    lex.register(
        PredicateId.hanging.value,
        PredicateLexeme(kind=PredicateForm.PREP, label="hanging on"),
    )
    ...
    # ---------- state (ADJ) ----------
    lex.register(
        PredicateId.isOpen.value, PredicateLexeme(kind=PredicateForm.ADJ, label="open")
    )
    lex.register(
        PredicateId.isDirty.value,
        PredicateLexeme(kind=PredicateForm.ADJ, label="dirty"),
    )
    lex.register(
        PredicateId.isBroken.value,
        PredicateLexeme(kind=PredicateForm.ADJ, label="broken"),
    )
    lex.register(
        PredicateId.isToggled.value,
        PredicateLexeme(kind=PredicateForm.ADJ, label="turned on"),
    )
    lex.register(
        PredicateId.isMoving.value,
        PredicateLexeme(kind=PredicateForm.ADJ, label="moving"),
    )
    lex.register(
        PredicateId.isPickedUp.value,
        PredicateLexeme(kind=PredicateForm.ADJ, label="picked up"),
    )
    lex.register(
        PredicateId.isFilledWithLiquid.value,
        PredicateLexeme(kind=PredicateForm.ADJ, label="filled with liquid"),
    )
    lex.register(
        PredicateId.isCooked.value,
        PredicateLexeme(kind=PredicateForm.ADJ, label="cooked"),
    )
    lex.register(
        PredicateId.isSliced.value,
        PredicateLexeme(kind=PredicateForm.ADJ, label="sliced"),
    )
    lex.register(
        PredicateId.isUsedUp.value,
        PredicateLexeme(kind=PredicateForm.ADJ, label="used up"),
    )

    # ---------- value/data labels (ATTR) ----------
    lex.register(
        PredicateId.temperature.value,
        PredicateLexeme(
            kind=PredicateForm.PROP_VALUE, label="temperature", template_mode="value"
        ),
    )
    lex.register(
    ...
    lex.register(
        PredicateId.salientMaterials.value,
        PredicateLexeme(
            kind=PredicateForm.PROP_VALUE, label="material", template_mode="value"
        ),
    )
    ...
    for pid, text in [
        ...
        lex.register(
            pid.value, PredicateLexeme(kind=PredicateForm.PROP_STATE, label=text)
        )
