...
from src.epistemic.enums import Verdict, ClaimStructure, EvidenceType
from src.adapters.ai2thor.claims.types import ClaimCorpus, ClaimInstance
from src.infra.graph.types import Term, Triple, TripleList
from src.nlg.triple_realizer import TripleRealizer
from src.adapters.ai2thor.claims.result import (
    ClaimGenerationStats,
    ClaimGenerationStatsSummary,
)
